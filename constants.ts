...
export const LOCALIZATION: Record<Language, any> = {
  [Language.EN]: {
    navHome: "Home",
    navTours: "Itineraries",
    navFleet: "Our Vehicles",
    ...
    fleetTitle: "Ethio Journey Vehicles",
    bookNow: "Reserve Now",
    perDay: "/ day",
    amharic: "አማርኛ",
    english: "English",
    aiTitle: "AI Concierge",
    aiPlaceholder: "Ask about our vehicles or destinations...",
    bookingTitle: "Secure Reservation",
    paymentTitle: "Gateway Transfer",
    confirmTitle: "Booking Confirmed",
    servicesTitle: "Handpicked Excellence",
